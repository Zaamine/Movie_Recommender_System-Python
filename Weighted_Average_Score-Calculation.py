...
# We have to convert the 'vote_count' column which is a string type
# to a double type (numerical) in order to calculate the quantile
...
# collect() is used to return all the elements of the dataset as an
# array at the driver program. This is usually useful after a filter
# or other operation that returns a sufficiently small subset of the
# data.
